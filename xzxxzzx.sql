...
INSERT INTO `flavor` VALUES (1,'Regular'),(2,'Pork'),(3,'Beef'),(4,'Chicken'),(5,'Chocolate'),(6,'Macha');
...
INSERT INTO `ingredient_stock` VALUES (1,1,50.00,'2026-01-01','2025-09-08 13:18:19'),(2,2,50.00,'2026-02-01','2025-09-08 13:18:19'),(3,3,50.00,'2027-01-01','2025-09-08 13:18:19'),(4,4,50.00,'2025-12-31','2025-09-08 13:18:19'),(5,5,50.00,'2025-12-31','2025-09-08 13:18:19'),(6,6,50.00,'2025-12-31','2025-09-08 13:18:19'),(7,7,50.00,'2025-12-31','2025-09-08 13:18:19'),(8,8,50.00,'2025-11-01','2025-09-08 13:18:19'),(9,9,50.00,'2025-11-01','2025-09-08 13:18:19'),(10,10,50.00,'2026-06-01','2025-09-08 13:18:19'),(11,11,50.00,'2026-06-01','2025-09-08 13:18:19'),(12,12,50.00,'2025-11-05','2025-09-08 13:18:19'),(13,13,50.00,'2026-03-01','2025-09-08 13:18:19'),(14,14,50.00,'2027-01-01','2025-09-08 13:18:19'),(15,15,50.00,'2025-10-15','2025-09-08 13:18:19'),(16,16,50.00,'2025-09-30','2025-09-08 13:18:19'),(17,17,50.00,'2026-01-01','2025-09-08 13:18:19'),(18,18,50.00,'2026-01-01','2025-09-08 13:18:19'),(19,19,50.00,'2026-01-01','2025-09-08 13:18:19'),(20,20,50.00,'2025-09-20','2025-09-08 13:18:19'),(21,21,50.00,'2025-12-31','2025-09-08 13:18:19'),(22,22,50.00,'2026-01-01','2025-09-08 13:18:19'),(23,23,50.00,'2025-09-15','2025-09-08 13:18:19'),(24,24,50.00,'2025-12-31','2025-09-08 13:18:19'),(25,25,50.00,'2025-10-10','2025-09-08 13:18:19'),(26,26,50.00,'2026-03-01','2025-09-08 13:18:19'),(27,27,50.00,'2027-01-01','2025-09-08 13:18:19'),(28,28,50.00,'2026-05-15','2025-09-08 13:18:19'),(29,29,50.00,'2025-10-20','2025-09-08 13:18:19'),(30,30,50.00,'2025-10-25','2025-09-08 13:18:19'),(31,31,50.00,'2025-10-18','2025-09-08 13:18:19'),(32,32,20.00,'2025-10-19','2025-09-08 13:18:19'),(33,33,50.00,'2026-04-01','2025-09-08 13:18:19'),(34,34,50.00,'2025-10-15','2025-09-08 13:18:19');
...
INSERT INTO `menu_branches` VALUES (1,2),(1,4),(1,1),(1,5),(1,3);
...
INSERT INTO `menu_detail` VALUES (1,1,99.99,'00:30:00'),(2,2,49.99,'00:30:00'),(3,2,54.99,'00:30:00'),(4,2,59.99,'00:30:00'),(5,3,50.00,'00:30:00'),(6,3,65.00,'00:30:00'),(7,3,70.00,'00:30:00'),(8,4,49.00,'00:30:00'),(9,5,49.00,'00:30:00'),(10,5,53.00,'00:30:00'),(11,4,59.00,'00:30:00');
...
--
-- Table structure for table `menu_flavor`
--
...
CREATE TABLE `menu_flavor` (
  `xcvv1menu_flavorcol` bigint NOT NULL,
  `menu_detail_id` bigint NOT NULL,
  `flavor_id` bigint NOT NULL,
  PRIMARY KEY (`xcvv1menu_flavorcol`),
  KEY `353453_idx` (`menu_detail_id`),
  KEY `zxczxc33232_idx` (`flavor_id`),
  CONSTRAINT `353453` FOREIGN KEY (`menu_detail_id`) REFERENCES `menu_detail` (`menu_detail_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `zxczxc33232` FOREIGN KEY (`flavor_id`) REFERENCES `flavor` (`flavor_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `menu_flavor`
--

LOCK TABLES `menu_flavor` WRITE;
/*!40000 ALTER TABLE `menu_flavor` DISABLE KEYS */;
INSERT INTO `menu_flavor` VALUES (1,2,2),(2,3,3),(3,4,4),(4,9,5),(5,10,6);
/*!40000 ALTER TABLE `menu_flavor` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `menu_size` (
  `xczxc` varchar(45) NOT NULL,
  `menu_detail_id` bigint NOT NULL,
  `size_id` bigint NOT NULL,
  PRIMARY KEY (`xczxc`),
  KEY `zxczxc123444_idx` (`size_id`),
  KEY `vcvcvcvhhh_idx` (`menu_detail_id`),
  CONSTRAINT `vcvcvcvhhh` FOREIGN KEY (`menu_detail_id`) REFERENCES `menu_detail` (`menu_detail_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `zxczxc123444` FOREIGN KEY (`size_id`) REFERENCES `size` (`size_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `menu_size` VALUES ('1',5,1),('2',6,2),('3',7,3),('4',8,1),('5',11,2),('6',9,2),('7',10,1);
...
/*!50001 VIEW `x_retrieve_menu` AS select `m`.`menu_id` AS `menu_id`,`m`.`menu_name` AS `menu_name`,`c`.`category_id` AS `category_id`,`m`.`menu_description` AS `menu_description`,any_value(`m`.`image`) AS `image`,`m`.`isAvailable` AS `isAvailable`,`mb`.`branches_id` AS `branches_id`,`md`.`menu_detail_id` AS `menu_detail_id`,`md`.`price` AS `lowerPrice` from (((`menu` `m` join `menu_branches` `mb` on((`mb`.`menu_id` = `m`.`menu_id`))) join `category` `c` on((`c`.`category_id` = `m`.`category_id`))) join (select `md1`.`menu_id` AS `menu_id`,`md1`.`menu_detail_id` AS `menu_detail_id`,`md1`.`price` AS `price` from (`menu_detail` `md1` join (select `menu_detail`.`menu_id` AS `menu_id`,min(`menu_detail`.`price`) AS `min_price` from `menu_detail` group by `menu_detail`.`menu_id`) `md2` on(((`md1`.`menu_id` = `md2`.`menu_id`) and (`md1`.`price` = `md2`.`min_price`))))) `md` on((`md`.`menu_id` = `m`.`menu_id`))) group by `m`.`menu_id`,`md`.`menu_detail_id`,`m`.`menu_name`,`m`.`menu_description`,`m`.`isAvailable`,`mb`.`branches_id`,`c`.`category_id` */;
...
-- Dump completed on 2025-09-11 15:48:09
